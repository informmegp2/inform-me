    ...
    override func viewDidLoad() {
        ...
        for subview in self.view.subviews
        {
            if (subview.isKindOfClass(UITextField))
            {
                ...
                textField.addTarget(self, action: #selector(ResponsiveTextFieldViewController.textFieldDidBeginEditing(_:)), forControlEvents: UIControlEvents.EditingDidBegin)
                print(textField)
            }
        }
